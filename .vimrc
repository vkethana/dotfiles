...
map <M-Bslash> :w <CR> :!clang -Wshadow -Wall -fsanitize=address -fsanitize=undefined -D_GLIBCXX_DEBUG -g -std=c++17 -O2 % -o %< && %< <CR> " This might not work if you use the header <bits/stdc++.h> in your program
inoremap jj <Esc>
...
inoremap {{ {
inoremap {} {}
command AllNotes e "I use this to quickly open a txt file where I take notes. You will need to add a file path yourself
